<?php
if (!class_exists('chiaSheng_Popular_Post_Widget')) :
    /**
     * Adds chiaSheng_Popular_Post_Widget widget.
     */
    class chiaSheng_Popular_Post_Widget extends chiaSheng_Widget_Base
    {
        /**
        ...
        {
            $this->text_fields = array('chiaSheng-popular-posts-ttl', 'chiaSheng-count-posts');
            $this->select_fields = array('chiaSheng-select-cat');

            $widget_ops = array(
                'classname' => 'chiaSheng_popular_post_widget',
                'description' => __('Displays posts from selected category.', 'chiaSheng'),
                'customize_selective_refresh' => true,
            );

            parent::__construct('chiaSheng_popular_post_widget', __('DT: Popular Posts', 'chiaSheng'), $widget_ops);
        }
        ...
        public function widget($args, $instance)
        {
            ...
            $title = apply_filters('widget_title', $instance['chiaSheng-popular-posts-ttl'], $instance, $this->id_base);
            $category = isset($instance['chiaSheng-select-cat']) ? $instance['chiaSheng-select-cat'] : '0';
        ...
        public function form($instance)
        {
            ...
            if (isset($categories) && !empty($categories)) {
                ...
                echo parent::chiaSheng_generate_text_input('chiaSheng-popular-posts-ttl', 'Title', 'Popular Posts');
                echo parent::chiaSheng_generate_select_options('chiaSheng-select-cat', __('Select Category', 'chiaSheng'), $categories);
