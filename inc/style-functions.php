 ...
 * @return [string]
 */
function ChiaSheng_media_range( $css_prop, $obj_value, $default, $media = 'desktop', $ext = '' ) {
...
/**
 * Takes Ranges Control applies to chiasheng_media_range function and outputs Full css with @media query
 * @param  [string] $css_prop CSS Property to add
