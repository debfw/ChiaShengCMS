 ...
 */
return array(
	'title'      => __( 'Default footer', 'Chia Sheng CMS' ),
	...
	'content'    => '<!-- wp:group {"align":"full","layout":{"inherit":true}} -->
					...
					sprintf(
						...
						esc_html__( 'Proudly powered by %s', 'Chia Sheng CMS' ),
						'<a href="' . esc_url( __( 'https://wordpress.org', 'Chia Sheng CMS' ) ) . '" rel="nofollow">WordPress</a>'
					) . '</p>
					<!-- /wp:paragraph --></div>
					<!-- /wp:group --></div>
					<!-- /wp:group -->',
